...
code mode or infer that it is unavailable from a previous failed rendering.
Treat the picker as unavailable only when no native question tool is exposed in
